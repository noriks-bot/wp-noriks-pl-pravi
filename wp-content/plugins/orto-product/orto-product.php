...
.color-hnědá {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter', 'orto-majice', 'orto-majica', 'orto-bokserice', 'orto-kompresijske-carape', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers', 'orto-majica-darila', 'orto-leak-boxers', 'orto-kompresijske-majice', 'orto-ortopedski-jastuk', 'orto-kidsnest' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
...
function gck_order_item_meta( $item, $cart_item_key, $values, $order ) {
    ...
    if ( ! empty( $values['_orto_lines'] ) && is_array( $values['_orto_lines'] ) ) {
        ...
        $item->add_meta_data( 'Wybrany zestaw', sanitize_text_field( $meta_value ), true );
    }
