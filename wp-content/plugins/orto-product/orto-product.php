...
.color-hnědá {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter', 'orto-majice', 'orto-majica', 'orto-bokserice', 'orto-kompresijske-carape', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers', 'orto-majica-darila', 'orto-leak-boxers', 'orto-kompresijske-majice' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
