...
<link rel="icon" href="https://vigoshop.pl/app/uploads/2018/03/cropped-vigoshop-fb-profilna-puscica-1-32x32.png" sizes="32x32" />
<link rel="icon" href="https://vigoshop.pl/app/uploads/2018/03/cropped-vigoshop-fb-profilna-puscica-1-192x192.png" sizes="192x192" />
<link rel="apple-touch-icon" href="https://vigoshop.pl/app/uploads/2018/03/cropped-vigoshop-fb-profilna-puscica-1-180x180.png" />
<meta name="msapplication-TileImage" content="https://vigoshop.pl/app/uploads/2018/03/cropped-vigoshop-fb-profilna-puscica-1-270x270.png" />
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon-precomposed" sizes="60x60" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-60x60.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon-precomposed" sizes="120x120"
          href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon-precomposed" sizes="152x152"
          href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/apple-touch-icon-152x152.png">
    <link rel="icon" type="image/png" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/favicon-16x16.png" sizes="16x16"/>
    <link rel="icon" type="image/png" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/favicon-32x32.png" sizes="32x32"/>
    <link rel="icon" type="image/png" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/favicon-96x96.png" sizes="96x96"/>
    <link rel="icon" type="image/png" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/favicon-128.png" sizes="128x128"/>
    <link rel="icon" type="image/png" href="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/favicon-196x196.png" sizes="196x196"/>
    <meta name="application-name" content="vigoshop"/>
    <meta name="msapplication-TileColor" content="#FFFFFF"/>
    <meta name="msapplication-TileImage" content="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/mstile-144x144.png"/>
    <meta name="msapplication-square70x70logo" content="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/mstile-70x70.png"/>
    <meta name="msapplication-square150x150logo" content="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/mstile-150x150.png"/>
    <meta name="msapplication-wide310x150logo" content="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/mstile-310x150.png"/>
    <meta name="msapplication-square310x310logo" content="https://vigoshop.pl/app/themes/hsplus/images/favicon/vigoshop/mstile-310x310.png"/>
    </head>
...
<div class="before_form container container--xs">
  ...
  <form name="checkout" method="post" class="checkout woocommerce-checkout"
        action="#" enctype="multipart/form-data" aria-label="Płatność">
    ...
    <h3 class="checkout-billing-title">Płatność i Dostawa</h3>

  
  
  <div class="woocommerce-billing-fields__field-wrapper">
    <p class="form-row form-row-first form-group col-xs-12 validate-required" id="billing_first_name_field" data-priority="30"><label for="billing_first_name" class="required_field">Imię&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_first_name" id="billing_first_name" placeholder="Imię"  value="" aria-required="true" maxlength="80" autocomplete="given-name" /></span></p><p class="form-row form-row-last form-group col-xs-12 validate-required" id="billing_last_name_field" data-priority="40"><label for="billing_last_name" class="required_field">Nazwisko&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_last_name" id="billing_last_name" placeholder="Nazwisko"  value="" aria-required="true" maxlength="80" autocomplete="family-name" /></span></p><div class="form-row form-row-wide col-xs-12">Wpisz adres, pod którym będziesz <b>w godzinach 8:00–16:00</b>.</div><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_1_field" data-priority="50"><label for="billing_address_1" class="required_field">Ulica&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_1" id="billing_address_1" placeholder="Ulica"  value="" aria-required="true" maxlength="80" autocomplete="address-line1" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required" id="billing_address_2_field" data-priority="60"><label for="billing_address_2" class="screen-reader-text required_field">Numer domu&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text form-input" name="billing_address_2" id="billing_address_2" placeholder="Numer domu"  value="" autocomplete="address-line2" maxlength="80" aria-required="true" /></span></p><p class="form-row form-row-wide address-field form-group form-group col-xs-12 validate-required validate-postcode" id="billing_postcode_field" data-priority="70"><label for="billing_postcode" class="required_field">Kod pocztowy&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_postcode" id="billing_postcode" placeholder="Kod pocztowy"  value="" aria-required="true" maxlength="30" autocomplete="postal-code" /></span></p><p class="form-row form-row-wide dropdown form-group form-group col-xs-12 validate-required" id="billing_city_field" data-priority=""><label for="billing_city" class="required_field">Miasto&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><select name="billing_city" id="billing_city" class="select form-input" aria-required="true" data-allow_clear="true" data-placeholder="Wybierz miasto">
							<option value=""  selected='selected'>Wybierz miasto</option>
						</select></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-required validate-phone" id="billing_phone_field" data-priority="10"><label for="billing_phone" class="required_field">Telefon&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><input type="tel" class="input-text form-input" name="billing_phone" id="billing_phone" placeholder="Numer telefonu komórkowego"  value="" maxlength="17" aria-required="true" autocomplete="tel" /></span></p><p class="form-row form-row-wide form-group col-xs-12 validate-email" id="billing_email_field" data-priority="20"><label for="billing_email" class="">Adres e-mail&nbsp;<span class="optional">(opcjonalnie)</span></label><span class="woocommerce-input-wrapper"><input type="email" class="input-text form-input" name="billing_email" id="billing_email" placeholder="Adres e-mail"  value="" maxlength="80" autocomplete="email" /></span></p><p class="form-row form-row-wide address-field form-group col-xs-12 validate-state" id="billing_state_field" data-priority="80"><label for="billing_state" class="">Województwo&nbsp;<span class="optional">(opcjonalnie)</span></label><span class="woocommerce-input-wrapper"><select name="billing_state" id="billing_state" class="state_select form-input" autocomplete="address-level1" data-placeholder="Wybierz województwo"  data-input-classes="form-input" data-label="Województwo">
						<option value="">Wybierz opcję&hellip;</option><option value="PL-DS" >Dolnośląskie</option><option value="PL-KP" >Kujawsko-pomorskie</option><option value="PL-LU" >Lubelskie</option><option value="PL-LB" >Lubuskie</option><option value="PL-LD" >Łódzkie</option><option value="PL-MA" >Małopolskie</option><option value="PL-MZ" >Mazowieckie</option><option value="PL-OP" >Opolskie</option><option value="PL-PK" >Podkarpackie</option><option value="PL-PD" >Podlaskie</option><option value="PL-PM" >Pomorskie</option><option value="PL-SL" >Śląskie</option><option value="PL-SK" >Świętokrzyskie</option><option value="PL-WN" >Warmińsko-mazurskie</option><option value="PL-WP" >Wielkopolskie</option><option value="PL-ZP" >Zachodniopomorskie</option></select></span></p><p class="form-row form-row-wide address-field update_totals_on_change form-group col-xs-12 validate-required" id="billing_country_field" data-priority="90"><label for="billing_country" class="required_field">Kraj&nbsp;<span class="required" aria-hidden="true">*</span></label><span class="woocommerce-input-wrapper"><strong>Polska</strong><input type="hidden" name="billing_country" id="billing_country" value="PL" aria-required="true" autocomplete="do-not-autofill" class="country_to_state" readonly="readonly" /></span></p><p class="form-row kl_newsletter_checkbox_field form-group col-xs-12" id="kl_newsletter_checkbox_field" data-priority=""><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="kl_newsletter_checkbox" id="kl_newsletter_checkbox" value="1" class="input-checkbox form-input"  /> Sign me up to receive email updates and news&nbsp;<span class="optional">(opcjonalnie)</span></label></span></p><p class="form-row form-row-wide hsplus-checkout-field hsplus-checkout-field--no-top-margin hsplus-checkout-field--hidden" id="hsplus_accepts_marketing_field" data-priority="11"><span class="woocommerce-input-wrapper"><label class="checkbox " ><input type="checkbox" name="hsplus_accepts_marketing" id="hsplus_accepts_marketing" value="1" class="input-checkbox woocommerce-form__input woocommerce-form__input-checkbox hsplus-checkbox"  /> Sign up for exclusive offers and news via text messages&nbsp;<span class="optional">(opcjonalnie)</span></label></span></p>  </div>
...
<div class="woocommerce-additional-fields">
		...
		<div class="woocommerce-additional-fields__field-wrapper">
							<p class="form-row notes form-group col-xs-12" id="order_comments_field" data-priority=""><label for="order_comments" class="">Uwagi do zamówienia&nbsp;<span class="optional">(opcjonalnie)</span></label><span class="woocommerce-input-wrapper"><textarea name="order_comments" class="input-text form-input" id="order_comments" placeholder="Uwagi do Twojego zamówienia.  "  rows="2" cols="5"maxlength="80"></textarea></span></p>					</div>
	...
	<div id="custom_shipping">
        ...
        <ul class="shipping_method_custom">
                ...
                <label
                    ...
                    <svg viewBox="0 0 19 14" fill="#3DBD00"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.5725 3.40179L8.14482 13.5874C7.5815 14.1375 6.66839 14.1375 6.1056 13.5874L0.422493 8.03956C-0.140831 7.48994 -0.140831 6.59748 0.422493 6.04707L1.44121 5.05126C2.00471 4.50094 2.91854 4.50094 3.48132 5.05126L7.12254 8.60835L15.5145 0.412609C16.078 -0.137536 16.9909 -0.137536 17.5537 0.412609L18.5733 1.40842C19.1424 1.95795 19.1424 2.8505 18.5725 3.40179Z" /></svg>                                        <div class="outer-wrapper">
                        ...
                        <strong
                            class="hs-custom-date">środa, 18.3. - czwartek, 19.3.</strong>
                        </div>
        ...
        <img decoding="async" class="delivery-from-eu-warehouse__icon"
            ...
            class="delivery-from-eu-warehouse__text">Magazyn w UE</span>
    </div>
    </div>
<div class="sup_outher_wrapper">
    ...
    <div class="surprise_upsells_wrapper">
                ...
                <div class="vigo-gift__tooltip">
                    <div class="flex flex--autosize flex--middle">
                        ...
                        <div class="flex__item f--bold">  Dodaj do zamówienia</div>
                    </div>
                </div>
                <div class="flex sup_inner_wrapper">
                    <div>
                        <div class="surprise_product_click flex flex--wrap flex--autosize flex--gaps flex--middle">
                            ...
                            <div class="f--l f--bold surprise_title">Produkt niespodzianka</div>
                        ...
                        <div class="f--m c--darkgray s-top--s">O wartości od 5 € do 15 €.</div>
                    </div>
    ...
    <h3 class="payment-title">Sposób płatności</h3>
  ...
  <label for="payment_method_cod">
    Płatność za pobraniem <span class="payment-fee-not-free"><span class="woocommerce-Price-amount amount">1,99<span class="woocommerce-Price-currencySymbol">&euro;</span></span></span><div class="hs-checkout__payment-method-cod-icon-container">
...
<li class="wc_payment_method payment_method_braintree_paypal">
  <input id="payment_method_braintree_paypal" type="radio" class="input-radio" name="payment_method" value="braintree_paypal"  data-order_button_text="Zamów" />

  <label for="payment_method_braintree_paypal">
    PayPal <span class="payment-fee-free">Bezpłatnie</span><img decoding="async" src="https://images.vigo-shop.com/general/checkout/paypal/PayPal.svg" alt="PayPal">  </label>
      <div class="payment_box payment_method_braintree_paypal" style="display:none;">
      <fieldset id="wc-braintree-paypal-paypal-form" aria-label="Informacje o płatności"><legend style="display:none;">Informacje o płatności</legend><div class="wc-braintree-paypal-new-payment-method-form js-wc-braintree-paypal-new-payment-method-form">		<input type="hidden" id="wc_braintree_paypal_payment_nonce" name="wc_braintree_paypal_payment_nonce" />
    ...
    <div class="pdf-title-container">
        <h3 class="pdf-title">
            KUP E-BOOKA<!--            <span class="green-label">-->
<!--                --><!--            </span>-->
        </h3>
    </div>
    <p class="pdf-description">Przy zakupie e-booka dostawa jest bezpłatna.</p>
...
<!--                </div>-->
            ...
            <div id="pdf-select-false" class="cell-grid column-selected top">
                ...
                <label for="ebook_false">Nie chcę e-booka</label>
            </div>
    ...
    <p class="pdf-more-info">
        ...
        <u>Więcej informacji o e-knjizi</u>
    </p>
...
<h3 class="place-order-title" style="display: block;">Podsumowanie zamówienia</h3>
<div class="vigo-checkout-total order-total shop_table woocommerce-checkout-review-order-table">
    <div class="grid m-top--s review-all-products-container">
        ...
        <div class="flex__item f--l">
            Razem: <span class="f--bold price_total_wrapper"><span class="woocommerce-Price-amount amount"><bdi>21,98<span class="woocommerce-Price-currencySymbol">&euro;</span></bdi></span>        </div>
    </div>
</div>
        ...
        <div id="order_review" class="woocommerce-checkout-review-order container container--xs bg--white">
            <button type="submit" class="button alt button--l button--block button--green button--rounded button--green-gradient" name="woocommerce_checkout_place_order" id="place_order" data-value="Zamów" />Zamów</button></div><div class="checkout-warranty flex flex--center flex--middle">
    ...
    <div class="flex__item--autosize f--m checkout-warranty__text">
        <strong>Kupuj bez obaw </strong><br>
        Zwrot pieniędzy w ciągu 90 dni    </div>
</div>
...
<div class="agreed_terms_txt">
    <span class="policy-agreement-obligation">Klikając przycisk <strong>Zamów</strong> akceptuję zamówienie z obowiązkiem zapłaty.</span> <br>
            ...
            Przeczytałem i akceptuję <a href="#" id="terms_conditions_link"> Ogólne warunki sprzedaży </a> i <a href="#" id="withdrawal_policy_link"> prawo do odstąpienia </a>.        </div>
    </div>
...
<div id="terms-conditions-popup" class="checkout-popup" style="display: none;">
    <div class="checkout-popup-wrapper">
        <div id="terms-conditions-content">
            <h2 class="ql-align-justify"><strong>Regulamin</strong></h2>
...
<p class="ql-align-justify">Dobro došli na web-mjesto <a href="https://vigoshop.pl">vigoshop.hr</a> kojim upravlja tvrtka HS plus d.o.o., Gmajna 8, SI-1236 Trzin (dalje u tekstu: tvrtka).</p>
<p class="ql-align-justify">Ovi se Regulamin primjenjuju na sve aktivnosti omogućene u internetskoj trgovini koja je dostupna na&nbsp;<a href="https://vigoshop.pl">vigoshop.hr</a> (dalje u tekstu: web-mjesto). Regulamin obvezujući su za sve korisnike. Molimo vas da ih pažljivo pročitate. Ako se ne slažete s bilo kojim dijelom ovih Općih uvjeta poslovanja ili ako se u potpunosti ne slažete s njima, ne smijete upotrebljavati naše web-mjesto i naše usluge. Regulamin predstavljaju valjani ugovor sklopljen između vas i tvrtke.</p>
...
<p class="ql-align-justify"><strong>Tvrtka</strong>&nbsp;je tvrtka HS plus d.o.o., Gmajna 8, SI-1236 Trzin koja je vlasnik web-mjesta&nbsp;<a href="https://vigoshop.pl">vigoshop.hr</a>&nbsp;i upravlja njime.</p>
<p class="ql-align-justify"><strong>Web-mjesto&nbsp;</strong>je web-mjesto dostupno na&nbsp;<a href="https://vigoshop.pl">https://vigoshop.hr</a>, kojom upravlja tvrtka, i u okviru koje djeluje internetska trgovina.</p>
...
<p class="ql-align-justify"><strong>Pravila o zaštiti privatnosti</strong>&nbsp;dokument je koji sadržava sve informacije o obradi osobnih podataka koja se odvija u okviru web-mjesta. Navedena Pravila o zaštiti privatnosti dostupna su&nbsp;<a href="https://vigoshop.pl/pravila-o-zastiti-privatnosti">ovdje</a>.</p>
<p class="ql-align-justify"><strong>Pravila o kolačićima</strong>&nbsp;dokument je koji sadržava sve informacije o upotrebi kolačića koja se odvija u okviru web-mjesta. Navedena Pravila o kolačićima dostupna su&nbsp;<a href="https://vigoshop.pl/pravila-o-kolacicima">ovdje</a>.</p>
<h2 class="ql-align-justify"><strong>2. VIGOSHOP.HR INTERNETSKA TRGOVINA</strong></h2>
<p class="ql-align-justify">Općim uvjetima poslovanja utvrđuje se rad internetske trgovine, definiraju prava i obveze korisnika i internetske trgovine te uređuje poslovni odnos između internetske trgovine i kupca.&nbsp;Regulamin koji vrijede u trenutku kupnje (u trenutku kada se vrši internetska narudžba) obvezujući su za kupca. Svaki put kada se izvrši narudžba, korisnik će biti obaviješten o Općim uvjetima poslovanja. Izvršavanjem narudžbe korisnik potvrđuje da je obaviješten o ovim Općim uvjetima poslovanja.</p>
...
<ul>
<li class="ql-align-justify">Płatność pouzećem – kupac plaća račun gotovinom ili kreditnom karticom dostavnom kuriru koji robu isporučuje na adresu kupca;</li>
<li class="ql-align-justify">Płatność kreditnom karticom;</li>
<li class="ql-align-justify">Płatność preko PayPala.</li>
</ul>
...
<p class="ql-align-justify">Sažetak postupka možete pronaći na kartici „Wymiana gwarancyjna” pri dnu web-mjesta.</p>
...
<p class="ql-align-justify">Sažetak postupka možete pronaći u kartici „Reklamacje i spory” na dnu web-mjesta.</p>
...
<p class="ql-align-justify">Więcej informacji o platformi za rješavanje sporova potražite na <a href="https://ec.europa.eu/commission/presscorner/detail/hr/MEMO_13_193">ec.europa.eu</a>.</p>
<p class="ql-align-justify">
...
<p class="ql-align-justify">Więcej informacji u vezi s komunikacijom potražite u našim Pravilima o zaštiti privatnosti i Pravilima o kolačićima.</p>
...
<p class="ql-align-justify"><strong>Cjelokupnost ugovora</strong>&nbsp;Ovi Regulamin predstavljaju cjelokupnost sporazuma koji se primjenjuje između ugovornih strana. Svi potencijalni prethodni pisani ili usmeni sporazumi ili pregovori bit će u potpunosti zamijenjeni ovim Općim uvjetima poslovanja.</p>
<p class="ql-align-justify"><strong>Jezične verzije&nbsp;</strong>Ovi su Regulamin bili izrađeni na slovenskom jeziku. Svaka izmjena ovih Općih uvjeta poslovanja na bilo kojem drugom jeziku pripremljena je kako bi se omogućio lakši pristup Općim uvjetima poslovanja. Ovim se slažete i u potpunosti razumijete da će slovenska verzija imati prednost u slučaju bilo kakvih sporova.</p>
...
<div id="withdrawal-policy-popup" class="checkout-popup" style="display: none;">
    <div class="checkout-popup-wrapper">
        <div id="withdrawal-policy-content">
            <h2 class="ql-align-justify"><strong>PRAWO DO ODSTĄPIENIA OD ZAKUPU</strong></h2>
...
<p class="ql-align-justify">U slučaju zamjene proizvoda ili povrata novca ispunite: <a href="https://rma.hs-plus.com/language/pl_PL/">LINK</a></p>
...
<p class="ql-align-justify"><strong>Polska</strong></p>
    ...
    <div class="inner_wrapper">
        ...
        <div class="partial_inner_section">
            ...
            <div class="text_wrapper">
                ...
                <div class="text_wrapper">Płatność pouzećem</div>
            </div>
            ...
            <div class="text_wrapper delivery-from-eu-warehouse__text">Magazyn w UE</div>
        </div>
            </div>
</div>
            ...
            <div class="footer-mobile-payment__links">
                <div class="footer-mobile-payment__links-content  s-left--s s-right--s s-bottom--m opened">
                    <div class="footer-main__links">
                        <ul>
                                                            <li>
                                    <a href="https://vigoshop.pl/opci-uvjeti-poslovanja/"
                                       class="button button--link c--gray">Regulamin</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/pravila-o-zastiti-privatnosti/"
                                       class="button button--link c--gray">Pravila o zaštiti privatnosti</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/pravila-o-kolacicima/"
                                       class="button button--link c--gray">Pravila o kolačićima</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/pravo-na-odustajanje-od-kupnje/"
                                       class="button button--link c--gray">Prawo do odstąpienia od zakupu</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/prituzbe-i-sporovi/"
                                       class="button button--link c--gray">Reklamacje i spory</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/zamjena-u-jamstvu/"
                                       class="button button--link c--gray">Wymiana gwarancyjna</a>
                                </li>
                                                            <li>
                                    <a href="https://vigoshop.pl/informacije-o-tvrtki/"
