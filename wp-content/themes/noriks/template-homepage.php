...
get_header(); ?>
  ...
  <div class="hero__media" aria-hidden="true">
    ...
    <img
      src="/pl/wp-content/themes/noriks/img/noriks-hero.jpeg"
      alt=""
    />
  </div>
  ...
  <div class="hero__content">
    ...
    <h1 class="hero__title">Koszulka, która rozwiązuje wszystkie problemy.</h1>

    <a class="hero__btn" href="/pl/shop">KUP TERAZ</a>
  </div>
</section>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Kupuj według kolekcji</h2>

    <a class="collections__cta" href="/pl/shop">
      Wszystkie produkty <span aria-hidden="true">›</span>
    </a>
  </div>

  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="https://noriks.com/pl/product-category/koszulki/">
      <div class="collection-card__media">
        <img
          src="/pl/wp-content/themes/noriks/img/noriks-majice.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Koszulki</h3>
          </div>
          <p class="collection-card__desc">
         Komfort przez cały dzień. Bez ucisku.
          </p>
        </div>
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="https://noriks.com/pl/product-category/bokserki/">
      <div class="collection-card__media">
        <img
          src="/pl/wp-content/themes/noriks/img/noriks-boksarice.jpeg"
          alt="V-neck t-shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Bokserki</h3>
          </div>
          <p class="collection-card__desc">
         Miękkie. Przewiewne. Niezawodne.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="https://noriks.com/pl/product-category/komplety/">
      <div class="collection-card__media">
        <img
          src="/pl/wp-content/themes/noriks/img/noriks-kompleti.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Komplety</h3>
       
          </div>
          <p class="collection-card__desc">
Najlepsza wartość w pakiecie.
          </p>
        </div>
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="https://noriks.com/pl/product-category/pakiety-startowe/">
      <div class="collection-card__media">
        <img
          src="/pl/wp-content/themes/noriks/img/starter-paket_.jpeg"
          alt="Long sleeve shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Pakiet startowy</h3>
           
           
          </div>
          <p class="collection-card__desc">
Wypróbuj NORIKS w lepszej cenie.
