<?php
/**
 * Template Name: Instrukcja obsługi
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Pobierz instrukcję swojego produktu NORIKS w formacie PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Szukaj po nazwie produktu…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Pobierz PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Strona produktu</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Brak instrukcji dla tego hasła. Napisz do nas na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Potrzebujesz pomocy z produktem? Napisz do nas na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
