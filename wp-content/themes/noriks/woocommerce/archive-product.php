...
<nav class="category-menu">
  <ul>
    ...
    <li class="<?php echo is_active_menu_item('/product-category/koszulki') ? 'active' : ''; ?>">
      <a href="/pl/product-category/koszulki/">Koszulki</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/bokserki') ? 'active' : ''; ?>">
      <a href="/pl/product-category/bokserki/">Bokserki</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/komplety') ? 'active' : ''; ?>">
      <a href="/pl/product-category/komplety/">Komplety</a>
    </li>

<!--
    <li class="<?php echo is_active_menu_item('/product-category/skarpety') ? 'active' : ''; ?>">
      <a href="/pl/product-category/skarpety/">Skarpety</a>
    </li>
    -->
...
} elseif ( is_product_category_or_child('bokserki') ) {

    echo do_shortcode('[yith_wcan_filters slug="default-preset-2"]');

// CATEGORY GROUP
} elseif (
    is_product_category_or_child('bestsellery') ||
    is_product_category_or_child('duze-pakiety') ||
    is_product_category_or_child('pakiety-startowe')
) {

    echo do_shortcode('[yith_wcan_filters slug="default-preset"]');

// CATEGORY: /majice + children
} elseif ( is_product_category_or_child('koszulki') ) {

    echo do_shortcode('[yith_wcan_filters slug="default-preset-2-2"]');

// CATEGORY: /kompleti + children
} elseif ( is_product_category_or_child('komplety') ) {

    echo do_shortcode('[yith_wcan_filters slug="default-preset-2-2-2-2"]');

// CATEGORY: /carape + children
} elseif ( is_product_category_or_child('skarpety') ) {
