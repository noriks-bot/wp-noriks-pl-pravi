...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    line-height: 1.214;
    font-weight: bold;  font-family: 'Inter', sans-serif;">Podsumowanie zamówienia</h2>
    
    <div style="width: 100%; background: black; color:black; height: 1px;"class="line-separator"></div>

	<table style="margin-top:5px;" cellspacing="0" class="shop_table shop_table_responsive">
