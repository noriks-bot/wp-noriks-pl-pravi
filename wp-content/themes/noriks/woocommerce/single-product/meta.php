    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
         ...
         <?php elseif( function_exists('noriks_is_type') && noriks_is_type('kneeheat', $current_product_id) ): ?>
                ...
                <strong>NORIKS KneeHeat</strong> to opaska na kolano, która w jednej sesji łączy trzy terapie: ciepło do 42 °C, kompresję powietrzną i masaż wibracyjny 60 Hz. Ciepło rozszerza naczynia krwionośne i ułatwia dopływ krwi do głębszych tkanek, rytmiczna kompresja wypycha nagromadzony płyn, a wibracje rozluźniają sztywność wokół stawu.<br><br>Sesja trwa 12 minut i uruchamia się jednym przyciskiem — bez aplikacji, bez ustawiania i bez kabla. Masz do dyspozycji 3 poziomy ciepła i 3 tryby wibracji, więc intensywność dopasujesz do dnia i dolegliwości.<br><br>Opaska ma ergonomiczny kształt i trzyma się na regulowanych paskach; pasuje na lewe i prawe kolano, a w zestawie jest też pasek przedłużający dla większych obwodów. Materiał przy skórze jest miękki i przewiewny.<br><br>Urządzenie ładuje się dołączonym kablem USB-C, a jedno ładowanie wystarcza na kilka sesji. Otrzymujesz 2 lata gwarancji wymiany.
         ...
         <?php elseif( function_exists('noriks_is_type') && noriks_is_type( 'kidsnest', $current_product_id ) ): ?>
                ...
                Poduszka NORIKS KidsNest wykonana jest z hipoalergicznej pianki memory z certyfikatem OEKO-TEX® — bez formaldehydu, metali ciężkich i BPA — z przewiewną poszewką z dzianiny.<br><br>Jej 3-strefowa ergonomiczna struktura delikatnie przyjmuje głowę, podpiera szyję i pomaga utrzymać kręgosłup w naturalnym ułożeniu — nawet gdy dziecko dużo obraca się w nocy. W ten sposób wspiera oddychanie przez nos oraz spokojniejszy, głębszy sen.<br><br>Dostępna w trzech rozmiarach (1–3, 3–9 i 9–14 lat), rośnie razem z dzieckiem i zapewnia właściwą wysokość podparcia na każdym etapie rozwoju.
...
<p>Wystarczy, że napiszesz do nas maila z informacją, że chcesz wymiany, a my od razu się tym zajmiemy.”</b></p>
    ...
    $noriks_manuals = array(
        'kidsnest' => array( 'noriks-kidsnest.pdf', 'NORIKS KidsNest — dziecięca poduszka ortopedyczna' ),
        'kneefix' => array( 'noriks-kneefix.pdf', 'NORIKS KneeFix — orteza ortopedyczna na kolano' ),
        'ortopedski-jastuk' => array( 'noriks-ergosit.pdf', 'NORIKS ErgoSit — poduszka ortopedyczna do siedzenia' ),
        'fisiorest' => array( 'noriks-fisiorest.pdf', 'NORIKS FisioRest — urządzenie na kark' ),
        'bunion' => array( 'noriks-bunion-fix.pdf', 'NORIKS Bunion Fix — korektor haluksów' ),
        'ortopas' => array( 'noriks-ortopas.pdf', 'Pas ortopedyczny NORIKS na plecy' ),
    );
    $noriks_manual = null;
      ...
      <div class="accordion-content">
        <a class="noriks-manual-link" href="<?php echo esc_url( get_template_directory_uri() . '/manuals/' . $noriks_manual[0] ); ?>" target="_blank" rel="noopener">
          ...
          <span class="noriks-manual-txt">
            ...
            <small>PDF · otwiera się w nowej karcie</small>
          </span>
