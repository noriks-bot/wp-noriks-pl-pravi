...
<div class="nhs-usp">
  <div class="nhs-usp-guarantee"><svg width="15" height="15" viewBox="0 0 24 24" style="flex:0 0 auto;"><circle cx="12" cy="12" r="12" fill="#7c3aed"/><path d="M7 12.5l3 3 7-7" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg> 30-dniowa gwarancja zwrotu pieniędzy</div>
  <div class="nhs-usp-grid">
    <div><span class="nhs-usp-ic">≈</span> Redukuje zmarszczki</div>
    <div><span class="nhs-usp-ic">↓</span> Redukuje drobne linie</div>
    <div><span class="nhs-usp-ic">♡</span> Rozjaśnia blizny przez noc</div>
    <div><span class="nhs-usp-ic">✚</span> Mocno przylega</div>
    <div><span class="nhs-usp-ic">✓</span> Wielokrotne i trwałe</div>
    <div><span class="nhs-usp-ic">↗</span> Pobudza produkcję kolagenu</div>
  </div>
</div>
<style>
  ...
  /* Countdown na tym produkcie: neutralnie szaro (bez czerwonego). */
  ...
  /* Discount badge (−33% …): fioletowy na tym produkcie. */
  .gck-discount-badge { background: #7c3aed !important; color: #fff !important; }
  /* Bundle radio przyciski: fioletowe na tym produkcie. */
...
<div class="kn2-badge">
  ...
  <span>Polecana przez pediatrów</span>
</div>
<div class="kn2-below">
  <div class="kn2-trust">
    <span><svg width="16" height="16" viewBox="0 0 24 24"><path d="M12 2l8 3v6c0 5-3.5 9.5-8 11-4.5-1.5-8-6-8-11V5l8-3z" fill="#2b3fb0"/><path d="M8.5 12l2.5 2.5 4.5-4.5" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> 90 nocy na wypróbowanie</span>
    <span><svg width="18" height="14" viewBox="0 0 24 18"><rect x="1" y="3" width="13" height="10" rx="1.5" fill="#2b3fb0"/><path d="M14 6h4l4 4v3h-8z" fill="#2b3fb0"/><circle cx="6" cy="15" r="2.4" fill="#1b2450"/><circle cx="18" cy="15" r="2.4" fill="#1b2450"/></svg> Szybka dostawa</span>
    <span><svg width="17" height="15" viewBox="0 0 24 20"><rect x="3" y="2" width="18" height="11" rx="2" fill="none" stroke="#2b3fb0" stroke-width="2"/><circle cx="12" cy="7.5" r="2.6" fill="#2b3fb0"/><path d="M2 17c3 2 7 3 10 3s7-1 10-3" fill="none" stroke="#2b3fb0" stroke-width="2" stroke-linecap="round"/></svg> Płatność także za pobraniem</span>
  </div>
  <div class="kn2-redbox">
    <p class="kn2-red-title"><svg width="14" height="13" viewBox="0 0 24 22" style="vertical-align:-2px;margin-right:6px;"><path d="M12 1L23 21H1L12 1z" fill="none" stroke="#c0452f" stroke-width="2.4" stroke-linejoin="round"/><path d="M12 8v6" stroke="#c0452f" stroke-width="2.4" stroke-linecap="round"/><circle cx="12" cy="17.4" r="1.3" fill="#c0452f"/></svg>DLA RODZICÓW DZIECI PONIŻEJ 9. ROKU ŻYCIA</p>
    <p class="kn2-red-body">Każdej nocy na niewłaściwej poduszce <strong class="kn2-red">twarz Twojego dziecka się kształtuje — w złym kierunku.</strong> Ślinienie. Chrapanie. Otwarte usta. Do <strong class="kn2-red">9. roku życia</strong> zmiany się utrwalają. Do <strong class="kn2-red">14.</strong> — drogi aparat na zęby. Do <strong class="kn2-red">18.</strong> — rozmowa o poważniejszych zabiegach. Stomatolodzy dziecięcy zajmujący się drogami oddechowymi widzą to codziennie — przestali nazywać to rzadkością. <strong class="kn2-red">Zmień poduszkę już dziś wieczorem.</strong></p>
  </div>
</div>
<style>
  /* Badge iznad naslova */
...
(function(){
  function init(){
    ...
    /* Ribboni: strip ogenj + dodaj "Najlepsza wartość" na 3. karto */
    document.querySelectorAll('.gck-popular-badge, .gck-popular-badge-2').forEach(function(b){ b.textContent=b.textContent.replace('🔥','').trim(); if(/Ulubiony/i.test(b.textContent)) b.textContent='Ulubiony'; });
    ...
    if(cards.length>=3 && !cards[2].querySelector('.kn2-ribbon') && !cards[2].querySelector('.gck-popular-badge, .gck-popular-badge-2')){
      var rb=document.createElement('div'); rb.className='kn2-ribbon'; rb.textContent='Najlepsza wartość'; cards[2].appendChild(rb);
    }
    /* Ikone + dostava-box prestavi POD accordion */
...
<div class="oj-recpill">
  <img src="<?php echo esc_url( get_template_directory_uri().'/img/ortopedski-jastuk/04_lijecnik_HR.png' ); ?>" alt="Lekarz" class="oj-recpill-av" onerror="this.style.display='none'">
  <span><strong>Poleca dr Mazur</strong>&nbsp;|&nbsp;<em>Specjalista chorób kręgosłupa</em></span>
...
<div class="oj-stockpill">
  ...
  <em>Zostało już tylko kilka sztuk!</em>
</div>
...
<div class="oj-orders">
  ...
  <em><strong>128 zamówień</strong> w ciągu ostatnich <strong>24 godzin!</strong></em>
</div>
<style>
...
<div class="ncl-trust">
  <span>Dla krystalicznie czystych szyb i kabin,</span>
  <span class="ncl-trust-stars">★★★★★</span>
  <span>ufa nam 138 452+ gospodarstw domowych</span>
</div>
<style>
