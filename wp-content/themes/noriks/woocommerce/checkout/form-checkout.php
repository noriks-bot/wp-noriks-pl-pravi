  ...
  <div class="checkout-coupon-inline">
    <p class="form-row cci-form-row-first">
      ...
      <input
        ...
        id="cci-coupon-input"
        class="input-text"
        placeholder="<?php esc_attr_e( 'Kod rabatowy lub karta podarunkowa', 'woocommerce' ); ?>"
      />
    </p>
...
(function($){
  ...
  function successHtml(){
    return '<div class="woocommerce-message" role="alert">Kupon zastosowany.</div>';
  }
  function errorHtml(){
    return '<ul class="woocommerce-error" role="alert"><li>Wprowadź prawidłowy kod rabatowy lub kod karty podarunkowej.</li></ul>';
  }
  ...
  $(ensureNoticeTarget);
        	...
        	<div id="order_review" class="woocommerce-checkout-review-order">
        	    ...
        	    <h3 class="checkout-section-title">Podsumowanie zamówienia</h3>
                 ...
                 <div class="inline-coupon-notices dekstopni"></div>
                   ...
                   <script>
                    (function($){
                      ...
                      function successHtml(){ return '<div class="woocommerce-message" role="alert">Kupon zastosowany.</div>'; }
                      function errorHtml(){   return '<ul class="woocommerce-error" role="alert"><li>Wprowadź prawidłowy kod rabatowy lub kod karty podarunkowej.</li></ul>'; }
