  ...
  <div class="review-all-products-container">
    <div class="vigo-checkout-total__content">
      ...
      <div class="c--darkgray review-section-container review-addons shipping_order_review">
        <div class="review-addons-title"><div>Standardowa dostawa - InPost</div></div>
                <div class="review-addons-price review-sale-price" id="noriks-shipping-price"><?php
          $shipping_total = (float) WC()->cart->get_shipping_total();
          if ( $shipping_total > 0 ) {
            echo '<span style="display:inline-block;padding:3px 10px;border-radius:5px;background:#e3e6e8;color:#5f6061;font-size:14px;font-weight:500;">' . number_format($shipping_total, 2, ',', ' ') . ' zł</span>';
          } else {
            echo '<span style="display:inline-block;padding:3px 10px;border-radius:5px;background:#9ce79c;color:#228b22;font-size:14px;font-weight:500;">Bezpłatnie</span>';
          }
        ?></div>
      </div>
