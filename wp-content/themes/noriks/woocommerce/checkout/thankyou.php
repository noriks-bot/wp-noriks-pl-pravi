                ...
                <div class="tyuo_product_section">
                    ...
                    <div class="product_data">
                        ...
                        <div class="right_section_wrapper">
                            ...
                            <div class="product_regular_price" id="ty-upsell-regular"><?php echo number_format($upsell_qty_regular[1], 2, ',', ' '); ?> zł</div>
                            <div class="product_new_sale_price" id="ty-upsell-price"><?php echo number_format($upsell_qty_prices[1], 2, ',', ' '); ?> zł</div>
                        </div>
                    </div>
