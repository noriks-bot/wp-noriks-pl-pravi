...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      <span><a href="/pl/shop">Darmowa dostawa dla zamówień powyżej 300 zł</a></span>
      <span><a href="/pl/shop">30 dni bez ryzyka – wypróbuj bez obaw</a></span>
    ...
    <div class="navbar-right">
      ...
      <div class="cart-auto-icon">
        ...
        <?php if ( class_exists( 'WooCommerce' ) ) : ?>
            <a class="header-cart" href="/pl/cart">
                <div class="cart-icon">
