 ...
 *   PL  pakiet-6-szt     (rodzic: koszulki)
...
function noriks_render_pack_switcher() {
    ...
    <div class="npk">
        ...
        <?php if ( $shown > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Wybierz pakiet', 'noriks' ); ?></div>
                ...
                <?php foreach ( $sizes as $s => $list ) :
                    ...
                    <a class="npk-size<?php echo $is_cur ? ' is-active' : ''; ?>"
                       ...
                       <?php echo $is_cur ? 'aria-current="true"' : ''; ?>>
                        <span class="npk-size-n"><?php echo (int) $s; ?> <?php esc_html_e( 'szt.', 'noriks' ); ?></span>
                        <span class="npk-size-p"><?php echo wp_kses_post( wc_price( $ppu ) ); ?><span class="npk-size-u"><?php esc_html_e( 'za sztukę', 'noriks' ); ?></span></span>
                    </a>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ( count( $same ) > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Kolor', 'noriks' ); ?></div>
            <div class="npk-scroll">
