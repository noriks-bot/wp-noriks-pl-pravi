...
add_action( 'wp_footer', function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  if (!btn) return;
	  btn.textContent = 'Wróć do wyboru';
...
function noriks_controlpro_atc_testimonial() {
    ...
    <div class="cpr-atc-rev">
        <img class="cpr-atc-avatar" src="<?php echo esc_url( $avatar ); ?>" alt="Zadowolony klient NORIKS ControlPro" loading="lazy">
        <div class="cpr-atc-body">
            <p class="cpr-atc-text">„Po operacji prostaty przez dwa lata regularnie robiłem ćwiczenia Kegla i nie widziałem większego postępu. Myślałem, że do końca życia będę nosić wkładki. Cztery tygodnie z tym urządzeniem i z 5 wkładek dziennie spadłem do zera."</p>
