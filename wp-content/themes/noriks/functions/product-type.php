...
/**
 * ============================================================
 * NORIKS — Central product-type resolver (PL)
 * ------------------------------------------------------------
 ...
 * unchanged; only the SLUG VALUES are Polish (+ universal orto-*).
 * ============================================================
 */
...
function noriks_product_type_map() : array {
    return array(
        ...
        'starter'   => array( 'pakiety-startowe', 'startovaci-balicek', 'orto-starter', 'orto-majica-bokserica' ),
        'majice'    => array( 'koszulki', 'majice', 'orto-majica', 'orto-majice' ),
        'bokserice' => array( 'bokserki', '1-sztuka-bokserki', 'pakiet-3-szt-bokserki', 'orto-bokserice', 'bokserice-sastavi-paket' ),
        'carape'    => array( 'skarpety', 'orto-kompresijske-carape' ),

        // --- sub-variants / special buckets ---
        'kompresijske-nogavice'   => array( 'skarpety', 'orto-kompresijske-carape' ),
        ...
        // KidsNest — dziecięca poduszka wspierająca oddychanie przez nos.
        ...
        'majice-bokserice-paketi' => array( 'komplety', 'kompleti', 'majice-i-bokserice-paketi' ),
