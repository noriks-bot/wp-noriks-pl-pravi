...
add_action('woocommerce_review_order_before_submit', function(){
    ...
    <div class="noriks-coupon-wrap" style="margin:12px 0 16px;">
        ...
        <div id="noriks-coupon-expanded" style="display:none;gap:8px;align-items:center;">
            ...
            <button type="button" style="padding:10px 20px;background:#000;color:#fff;border:none;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer;white-space:nowrap;" onclick="noriksApplyCoupon()">Zastosuj</button>
    ...
    function noriksApplyCoupon(){
        ...
        fetch('<?php echo esc_url(wc_get_checkout_url()); ?>?wc-ajax=apply_coupon',{
            ...
            if(isError){
                ...
                msg.innerHTML='❌ '+(txt||'Kod kuponu nije valjan.');
            }else{
            ...
            msg.textContent='Błąd. Spróbuj ponownie.';btn.textContent='Zastosuj';btn.disabled=false;
        });
    }
    </script>
    <?php
