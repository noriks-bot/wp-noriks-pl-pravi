 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+48...),
...
define( 'NORIKS_TEL_EXAMPLE', '512345678' );

/** Sporocilo ob napacni stevilki — eno samo mesto za ves trg. */
function noriks_tel_message() {
    return 'Sprawdź numer telefonu — wygląda na niekompletny. np. ' . NORIKS_TEL_EXAMPLE;
}
