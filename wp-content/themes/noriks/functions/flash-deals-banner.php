...
const NORIKS_FLASH_CAT   = 'wyprzedaz-letnia';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Wyprzedaż letnia">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Sezonowa obniżka</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Wyprzedaż letnia</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Przecena do wyczerpania zapasów</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Oferta kończy się za</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>dni</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>godz</em></span>
