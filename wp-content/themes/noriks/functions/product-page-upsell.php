	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Pokaż upsell pod przyciskiem (3x Niebieskie bokserki)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Dodaje ramkę "Kup razem i oszczędzaj" bezpośrednio pod przyciskiem Dodaj do koszyka. Klient wybiera rozmiar, a 3 sztuki są dodawane w cenie upsell. Dotyczy tylko tego produktu.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'total'      => 57,                   // ista cijena kao thank you upsell (3 x 4,99)
		'title'      => '3x Niebieskie bokserki',
