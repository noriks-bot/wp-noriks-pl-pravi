...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			...
			'duze-pakiety' => 'Duże pakiety',
			'pakiety-startowe' => 'Pakiety startowe',
		),
		'bokserki' => array(
			'1-sztuka-bokserki' => '1 sztuka',
			'pakiet-3-szt-bokserki' => 'Pakiet 3 szt.',
			'pakiet-5-szt' => 'Pakiet 5 szt.',
			'pakiet-7-szt' => 'Pakiet 7 szt.',
			'pakiet-10-szt' => 'Pakiet 10 szt.',
			'pakiet-15-szt-bokserki' => 'Pakiet 15 szt.',
			'czarne-bokserki' => 'Czarne',
			'kolorowe-bokserki' => 'Kolorowe',
		),
		'komplety' => array(
			'zestaw-25' => 'Zestaw: 2+5',
			'zestaw-410' => 'Zestaw: 4+10',
			'zestaw-55' => 'Zestaw: 5+5',
		),
		'koszulki' => array(
			'1-sztuka' => '1 sztuka',
			'pakiet-3-szt' => 'Pakiet 3 szt.',
			'pakiet-6-szt' => 'Pakiet 6 szt.',
			'pakiet-9-szt' => 'Pakiet 9 szt.',
			'pakiet-12-szt' => 'Pakiet 12 szt.',
			'pakiet-15-szt' => 'Pakiet 15 szt.',
			'czarne' => 'Czarne',
			'kolorowe' => 'Kolorowe',
		)
	) );
