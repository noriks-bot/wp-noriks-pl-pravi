 ...
 *
 * SCAFFOLD — media w motywie: img/fisiorest*.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

// 1) "Poparte nauką" — 4 karty.
$fis_science = array(
    array( 'title' => 'Garb na szyi',        'text' => 'Trakcja <strong>uwalnia napięcie i przywraca prawidłową postawę</strong>, redukując garb spowodowany „szyją smartfonową”.' ),
    array( 'title' => 'Ból szyi',            'text' => '<strong>Rozluźnia węzły mięśniowe i sztywność</strong> oraz <strong>przywraca naturalną krzywiznę szyi</strong>, zapewniając szybką ulgę w bólu.' ),
    array( 'title' => 'Zdrowy sen',          'text' => 'Kojąca terapia <strong>rozluźnia szyję i kręgosłup</strong>, zapewniając głęboki i regenerujący sen.' ),
    array( 'title' => 'Redukcja stresu',     'text' => 'Ciepły masaż i rozciąganie <strong>uwalniają nagromadzone napięcie</strong>, zwiększając komfort.' ),
);
...
$fis_experts = array(
    array( 'img' => $fis_i.'fis-strucnjak-1.jpg', 'name' => 'Marta Nowak', 'role' => 'Certyfikowana terapeutka masażu', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-2.jpg', 'name' => 'Anna Kowalska', 'role' => 'Fizjoterapeutka', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-3.jpg', 'name' => 'Joanna Kowalczyk', 'role' => 'Kręgarka', 'org' => '' ),
);
// 4) Doświadczenia użytkowników
$fis_ugc = array(
    array( 'vid' => $fis_v.'v09c.mp4', 'cap' => '„Po raz pierwszy od dawna wreszcie nie odczuwam bólu…”' ),
    array( 'vid' => $fis_v.'v06.mp4', 'cap' => '„Poduszka NORIKS to mój nowy codzienny niezbędnik…”' ),
    array( 'vid' => $fis_v.'v11c.mp4', 'cap' => '„Świetnie pomaga mi rozładować napięcie w szyi i ramionach.”' ),
    array( 'vid' => $fis_v.'v02c.mp4', 'cap' => '„Jeśli właśnie zostałaś mamą, to może być dokładnie to, czego potrzebujesz…”' ),
);
// 5) ThermoTrac 3-w-1
$fis_thermo = array(
    array( 'vid' => $fis_v.'v10.mp4', 'title' => 'Terapia trakcyjna' ),
    array( 'vid' => $fis_v.'v07.mp4', 'title' => 'Terapia wibracyjna' ),
    array( 'vid' => $fis_v.'v05.mp4', 'title' => 'Terapia ciepłem' ),
);
// 6) Cztery ulepszenia
$fis_upgrades = array(
    array( 't' => 'Akumulator',                   'd' => 'Zabierz ją wszędzie — bateria 2500 mAh wystarcza nawet na 2 godziny.' , 'ico' => 'battery-v2.png' ),
    array( 't' => 'Poszewka z jedwabiu morwowego', 'd' => 'Otulona chłodzącym jedwabiem dla miękkiego, luksusowego uczucia.' , 'ico' => 'silk-v2.png' ),
    array( 't' => 'Wyłączenie po 30 min',         'd' => 'Cztery 30-minutowe sesje na jednym ładowaniu, bez zmartwień.' , 'ico' => 'timer-v2.png' ),
    array( 't' => 'Regulowane ciepło',           'd' => 'Podgrzewanie do 50 °C z zaawansowaną technologią ThermoTrac.' , 'ico' => 'heat-v2.png' ),
);
?>
...
<section class="fis-science">
  <div class="fis-wrap">
    <div class="fis-box">
      <h2 class="fis-title">Poparte nauką: udowodniona ulga w pielęgnacji szyi</h2>
      <div class="fis-grid">
...
<section class="fis-hero">
  ...
  <div class="fis-hero-inner">
    <h2 class="fis-hero-title">Odblokuj głęboki reset dzięki połączonej sile korekcji postawy i relaksu</h2>
  </div>
</section>
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      <h2 class="fis-h2">Polecane przez ekspertów</h2>
      <p>„NORIKS to jedna z najlepszych poduszek na szyję dostępnych obecnie na rynku. Działam w branży wellness od ponad 25 lat i przetestowałam wiele poduszek na szyję — tym, co wyróżnia NORIKS, jest funkcja trakcji…</p>
      <p>Jeśli masz wysuniętą głowę lub „przygarbioną postawę”, trakcja może pomóc ponownie ustawić kręgi i w pełni podeprzeć ciało. Sama jej używam i polecam moim klientkom!”</p>
      <p class="fis-exp-author"><strong>Marta Nowak</strong><br>Certyfikowana terapeutka masażu</p>
    </div>
...
<section class="fis-thermo">
  <div class="fis-wrap">
    <p class="fis-eyebrow"><strong>ThermoTrac™</strong> technologia</p>
    <h2 class="fis-h2 fis-center">Poznaj terapię szyi 3-w-1</h2>
...
<section class="fis-upg">
  <div class="fis-wrap">
    <h2 class="fis-h2 fis-center">Cztery duże ulepszenia</h2>
...
<section class="fis-cheaper">
  <div class="fis-wrap fis-row2">
    ...
    <div class="fis-row2-copy">
      <p class="fis-eyebrow">BEZPIECZNA I RELAKSUJĄCA TERAPIA</p>
      <h2 class="fis-h2">14× taniej niż cotygodniowe wizyty</h2>
      <p>NORIKS zwraca się w dni, nie miesiące. Polecany przez terapeutów, zapewnia delikatną ulgę bez mocnego nacisku i ryzykownych zabiegów. Używaj go każdego wieczoru. Bez umawiania wizyt. Bez dojazdów. Bez powtarzających się kosztów — po prostu bezpieczna, regularna pielęgnacja szyi, kiedy tylko jej potrzebujesz.</p>
    </div>
  </div>
</section>
