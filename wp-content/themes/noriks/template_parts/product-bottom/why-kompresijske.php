...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Jak to działa w praktyce</h2>
...
<section class="why-section knc-compare-section">
  <div class="knc-compare-wrap">
    <h2 class="knc-compare-title">NORIKS vs inni</h2>
    <div class="knc-table-scroll">
      <table class="knc-table">
        <thead>
          <tr>
            <th class="knc-feat"></th>
            <th class="knc-comp">Klasyczne pończochy<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">Pończochy z TV<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">Nr 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Kompresja medyczna</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Zamek błyskawiczny do łatwego zakładania</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Samodzielne zakładanie bez pomocy</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Pończochy kompresyjne">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        DLACZEGO POŃCZOCHY KOMPRESYJNE?
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Lepsze krążenie, mniej zmęczenia</strong></p>
        <p class="description">Stopniowa kompresja delikatnie wspomaga przepływ krwi w kierunku serca, zmniejsza uczucie ciężkości i zmęczenia nóg oraz pomaga, aby nogi pozostały lekkie nawet przez najdłuższy dzień.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Mniejsze obrzęki</strong></p>
        <p class="description">Idealne na długie podróże, długie stanie lub siedzenie. Równomierny nacisk zmniejsza zatrzymywanie płynów oraz obrzęki kostek i łydek.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Wsparcie, które czuć</strong></p>
        <p class="description">Anatomiczny krój utrzymuje pończochę na miejscu, bez uciskania u góry. Uczucie mocnego, ale przyjemnego wsparcia przez cały dzień.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Co mówią nasi klienci</h2>
