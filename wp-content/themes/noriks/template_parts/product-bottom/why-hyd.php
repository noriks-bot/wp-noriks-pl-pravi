 ...
 *   1. Pokretna traka (marquee)             "3000 ppb · trajni filter · omiljena…"
...
$nhy_marquee = array(
  array( 'kap',     '3000 ppb maksimalna infuzija' ),
  array( 'beskraj', 'Trwały filtr, bez zamjena' ),
...
<!-- ============ 2) Zobacz, jak się pieni ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap">
    <h2 class="nhy-h2 nhy-center">Zobacz, jak się pieni</h2>
    <p class="nhy-fizz-text">Zobacz mocne bąbelki powstające podczas elektrolizy — to czysta infuzja wodoru w najlepszym wydaniu. Woda pozostaje przy tym klarowna i orzeźwiająca po każdym cyklu.</p>
    <div class="nhy-fizz">
...
<!-- ============ 3) Siła antyoksydantów, mniej stanów zapalnych ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Siła antyoksydantów, mniej stanów zapalnych</h2>
      <p>Woda wodorowa znana jest z silnego działania antyoksydacyjnego i przeciwzapalnego, które w badaniach naukowych wiąże się z korzyściami przy ponad 150 stanach.</p>
      <p>Badania kliniczne wykazały też, że wypicie trzech butelek wody wodorowej może mieć efekt antyoksydacyjny porównywalny ze spożyciem setek sztuk owoców i warzyw.</p>
      <p class="nhy-note">Woda wodorowa jest uzupełnieniem codziennego nawodnienia, a nie zamiennikiem terapii lekarskiej.</p>
    </div>
...
<section class="nhy-sec">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Prawdziwe historie użytkowników</h2>
  </div>
  <div class="nhy-wrap nhy-row2">
    ...
    <div class="nhy-copy">
      <ul class="nhy-stories">
        <li><strong>Regeneracja z większą energią</strong><span>„Nakon svakog treninga osjećam manje umora u mišićima. HydraH₂ mi je oporavak učinio jednostavnim."</span></li>
        <li><strong>Nawodnienie, które widać</strong><span>„Koža mi je punija i bolje hidrirana. Savršeno za svakodnevnu rutinu."</span></li>
        <li><strong>Praktycznie i czysto</strong><span>„Nema okusa plastike, punjenje preko USB-a je jednostavno. Moja svakodnevna boca."</span></li>
      </ul>
    </div>
  </div>
</section>

<!-- ============ 5) Zalety wody wodorowej ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Zalety wody wodorowej</h2>
  </div>
  <div class="nhy-wrap">
    <div class="nhy-perks">
      <div class="nhy-perk"><strong>Lepsze nawodnienie</strong><span>Wzbogaca wodę wodorem o wysokim stężeniu dla optymalnego nawodnienia.</span></div>
      <div class="nhy-perk"><strong>Akumulator wielokrotnego ładowania</strong><span>Ładowanie USB w mniej niż 60 minut utrzymuje butelkę gotową przez cały dzień.</span></div>
      <div class="nhy-perk"><strong>Trwały filtr</strong><span>Wbudowany filtr nie wymaga wymiany — oszczędza czas i pieniądze.</span></div>
      <div class="nhy-perk"><strong>Szybkie cykle</strong><span>Wybierz cykl 3 lub 10 minut, by dopasować dawkę wodoru.</span></div>
    </div>
  </div>
</section>

<!-- ============ 6) Zaawansowane wytwarzanie wodoru ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-media"><?php echo $nh_img('hyd-04-kako-radi.webp','PEM i SPE elektroliza — proizvodnja vodika'); ?></div>
    <div class="nhy-copy">
      <h2 class="nhy-h2">Zaawansowane wytwarzanie wodoru</h2>
      <p>Dzięki najwyższej klasy <strong>elektrolizie PEM i SPE</strong> NORIKS HYD wytwarza do <strong>3000 ppb</strong> wodoru cząsteczkowego w wodzie. Szklana butelka z podstawą ze stali nierdzewnej sprawia, że woda nigdy nie dotyka plastiku, a trwały filtr generatora eliminuje troskę o konserwację. Automatyczne odpowietrzanie usuwa pozostałe gazy dla czystego i bezpiecznego picia.</p>
      <ul class="nhy-check">
        <li>Elektrody tytanowe z powłoką platynową</li>
        <li>Wodór o czystości 99,99 %, produkty uboczne uchodzą przez odpowietrznik</li>
        <li>Działa z każdą wodą pitną, także destylowaną</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Gotowy podnieść nawodnienie na wyższy poziom?</h2>
      <p>Dołącz do tysięcy osób, które wzbogaciły swoją rutynę wellness wodą bogatą w wodór. Poczuj zastrzyk energii, lepszą regenerację i nawodnienie, które widać.</p>
      <a class="nhy-cta" href="#bundle-selector">Zamów NORIKS HYD</a>
    </div>
