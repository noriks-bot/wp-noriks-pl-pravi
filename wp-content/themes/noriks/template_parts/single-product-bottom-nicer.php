...
if ( has_term( array( 'bokserki', 'orto-bokserice', 'bokserice-sastavi-paket' ), 'product_cat', get_the_ID() ) ) {
...
<section style="display:block; max-width:1440px; margin:0 auto; padding-bottom:30px;" class="most-popular">
  <div class="container" style="padding-left:10px; padding-right:10px;">
    <h2 class="section-title" style="margin-bottom:20px;">Gotowe zestawy — prosto i szybko</h2>
