<?php
/**
 * Tablica velicina za NORIKS FIT Woman (orto-kompwom) — trg PL.
...
<div id="custom-size-chart-modal" class="kwsc" role="dialog" aria-modal="true" aria-labelledby="kwsc-title">
  <div class="kwsc-box">
  <div class="kwsc-bar">
    <h2 id="kwsc-title">Tabela rozmiarów</h2>
    <span id="close-size-chart-x" role="button" tabindex="0" aria-label="Zamknij">&times;</span>
  </div>

  <div class="kwsc-body">
    <p class="kwsc-lead">Rozmiar dobierz według <strong>obwodu biustu</strong> — to on decyduje, jak koszulka układa się na piersiach i barkach. Jeśli jesteś między dwoma rozmiarami, weź <strong>większy</strong>.</p>


    <div class="kwsc-scroll">
      <table class="kwsc-table">
        <thead>
          <tr><th scope="col">Rozmiar</th><th scope="col">Obwód biustu</th><th scope="col">Obwód talii</th></tr>
        </thead>
        <tbody>
    ...
    <div class="kwsc-how">
      <h3>Jak mierzyć</h3>
      <ol>
        <li><strong>Biust</strong> — przez najszersze miejsce biustu, taśma poziomo wokół ciała.</li>
        <li><strong>Talia</strong> — najwęższe miejsce talii, zwykle nieco powyżej pępka.</li>
        <li><strong>Wybierz wiersz</strong>, w którym mieszczą się obie liczby; jeśli wypadają w dwóch wierszach, weź większy rozmiar.</li>
      </ol>
      <p class="kwsc-note">Mierz na bieliźnie, nie na ubraniu. Taśma ma przylegać, ale nie ściskać.</p>
    </div>
  </div>
  </div>
</div>
