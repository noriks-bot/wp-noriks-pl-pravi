...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  <div class="size-chart-titlebar">
    <h2 id="custom-size-chart-title">Tabela rozmiarów</h2>
  ...
  <div  style="<?php if ( has_term( array( 'orto-starter', 'orto-majica-bokserica' ), 'product_cat', get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <?php if ( has_term( array( 'bokserki', 'orto-bokserice' , 'bokserice-sastavi-paket' ), 'product_cat', get_the_ID() )   && 
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Rozmiar</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Wymiary bokserek: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Wybierz ten sam rozmiar, który zwykle nosisz.</strong><br>Wymiary podane w centymetrach. Rozmiary mogą się różnić o &plusmn;1&ndash;2 cm. Jeśli jesteś między dwoma rozmiarami, wybierz mniejszy &mdash; materiał jest elastyczny.</p>
      </div>
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Jak zmierzyć biodra</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Owiń taśmę mierniczą wokół najszerszego miejsca bioder (przez pośladki), bez naciągania, i zapisz wynik w centymetrach.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Rozmiar</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Biodra (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','do 76 cm','do 30"'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm i więcej','61" i więcej') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Między dwoma rozmiarami?</strong> Polecamy większy rozmiar dla optymalnego komfortu i maksymalnej chłonności.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Rozmiar</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Odpowiednia waga</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Wybierz rozmiar według swojej wagi. Między dwoma rozmiarami? Dla mocniejszej kompresji wybierz mniejszy rozmiar.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
          ...
          <table class="noriks-sc">
            <thead>
              <tr>
                ...
                <th class="noriks-sc-empty" style="width:80px;">Rozmiar</th>
                <th>59-68 kg</th>
                <th>69-77 kg</th>
                <th>78-84 kg</th>
                <th>84-95 kg</th>
            ...
            <tbody>
              <tr>
                <th class="noriks-sc-vis-label" rowspan="11">Wzrost (cm)</th>
                <th>168 cm</th>
        ...
        <div class="noriks-sc-steps">
          <h3>Jak znaleźć swój rozmiar</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Znajdź swój <strong>wzrost</strong> w lewej kolumnie.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Znajdź swoją <strong>wagę</strong> w górnym wierszu.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>Pole, w którym się przecinają &mdash; to jest twój rozmiar.</span>
            </div>
          </div>
        </div>

        <div class="noriks-sc-pro">
          <span class="noriks-sc-pro-tag">PRO PORADA</span>
          <span>Jeśli jesteś między dwoma rozmiarami i chcesz <strong>luźniejszy krój</strong>, weź większy. Dla <strong>bardziej dopasowanego wyglądu</strong> weź mniejszy.</span>
        </div>

        <div class="noriks-sc-guarantee">
          <span class="noriks-sc-check">&#10003;</span>
          <span>Nie jesteś pewien? Bezpłatna wymiana rozmiaru w ciągu 30 dni.</span>
        </div>
      </div>
