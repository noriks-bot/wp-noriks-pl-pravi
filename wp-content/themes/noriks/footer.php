  ...
  <div class="footer-row">
    ...
    <div class="footer-col">
      <div class="link-section">
        ...
        <a style="margin-top:-10px;" href="https://devhr.noriks.com?dsd33">
        <span style="color: white; font-family: 'Roboto', sans-serif; font-size: 33px; font-weight: bold; letter-spacing: 1.75px;">NORIKS</span>
       
      </a>
        
              <p class="footer-brand-dec" style="padding-right: 100px; font-size:12px;" >NORIKS powstał, aby rozwiązać prosty, lecz często pomijany problem: mężczyźni zasługują na odzież, która naprawdę dobrze leży. Zrodzona z frustracji krótkimi, ciasnymi i źle skrojonymi basicami, marka NORIKS projektuje ponadczasowe ubrania dla mocniejszej sylwetki — dłuższe, wygodniejsze i starannie dopracowane tam, gdzie ma to największe znaczenie.
</p>
      </div>
    </div>
